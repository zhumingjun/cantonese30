...
// 注意：变量名用 StorageImpl，避免与 app.js 的 const Storage 在浏览器全局作用域冲突
// （两个顶层 const 同名会抛 SyntaxError，导致 app.js 不执行、页面白屏）
const StorageImpl = {
  get,
  save,
  today,
...
// 浏览器环境：暴露为全局 window.Storage；Node 测试：module.exports
